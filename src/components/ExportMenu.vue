...
import { Download, ChevronDown, FileText, FileSpreadsheet, Image, FileImage } from 'lucide-vue-next'
...
const { exportAsCSV, exportAsExcel, exportChartAsPNG, exportChartAsSVG, exportChartAsPDF } = useExport()
